...
class MonuContext {
	...
	func initializeMonu() {
		...
		guard let monu2 = Monu(id: "2", name: "Cuves de Sassenages", photo: photo2, details: "Découvrez un patrimoine hydrogéologique millénaire ! Classée parmi les sept merveilles du Dauphiné dès la fin du Moyen-âge, la grotte les Cuves a très tôt attiré les curieux de la région, inspirant de nombreuses croyances populaires et légendes...", longitude: 5.657654, latitude: 45.207801) else {
